		...
		x:while(true) {
			...
			case 2:
				...
				if(index <= 0) {
					...
					index--;
					System.out.println("다음정보(이름)>" + nameList[index]);
					System.out.println("다음정보(성별)>" + genderList[index]);
					System.out.println("다음정보(나이)>" + ageList[index]);
				}
				System.out.println("=======================================");
			...
			case 4:
				...
				if(index >= 0 && index < count) {
					System.out.println("현재정보(이름)>" + nameList[index]);
					System.out.println("현재정보(성별)>" + genderList[index]);
					System.out.println("현재정보(나이)>" + ageList[index]);
				}else {
			...
			case 5:
				 ...
				 */
				if(index >= 0 && index < count) {
					System.out.printf("현재정보(%s)>" , nameList[index]);
					nameList[index] = scan.next();
					System.out.printf("현재정보(%s)>" , genderList[index]);
					genderList[index] = scan.next();
					System.out.printf("현재정보(%s)>" , ageList[index]);
